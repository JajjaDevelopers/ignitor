  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="d-flex align-items-center justify-content-between">
      <a href="../forms/index.php" class="logo d-flex align-items-center">
        <img src="<?=base_url("assets/images/logo2.jpg")?>" alt="">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
            <li class="dropdown-item">
              <span class="text-danger"></span>&nbsp;&nbsp;<span>Pending Verifications</span>
            ...
            <li class="dropdown-item">
              <span class="text-danger"></span>&nbsp;&nbsp;<span>Pending Approvals</span>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2"><?=$user[0]["UserName"]?></span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?=$user[0]["FullName"];?></h6>
            </li>
            <li>
              <hr class="dropdown-divider">
            </li>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?=base_url("dashboard/logout")?>">
        ...
        <ul id="verify-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../verification/pendingVerification">
              <i class="bi bi-circle"></i><span>Verification</span>&nbsp;<span class="badge bg-danger badge-number"></span>
            </a>
          </li>
          <li>
            <a href="../approval/pendingApproval">
              <i class="bi bi-circle"></i><span>Approval</span>&nbsp;<span class="badge bg-danger badge-number"></span>
            </a>
          </li>
        </ul>
      </li><!-- End verify Nav -->
...
<div class="copyright text-white">
   <p class=""> &copy; Copyright <strong><span>JAJJA DEV<span></strong>. All Rights Reserved</p>
  </div>
</footer><!-- End Footer -->
<!--Script files-->
